...
// })
  ...
  // Typing effect
  const phrases = ['Full Stack Engineer.', '.NET & Angular Expert.', 'Clean Architecture Advocate.', 'Team Lead & Mentor.'];
  ...
  document.getElementById('downloadBtn').addEventListener('click', (e) => {
    e.preventDefault();
    alert('Resume download link — replace with actual PDF URL.');
  });
